...
using MicaWPF.Lite.Extensions;
using MicaWPF.Lite.Services;
...
public class MicaWindow : Window, IMicaWindow
{
    ...
    public static readonly DependencyProperty TitleBarTypeProperty = DependencyProperty.Register(nameof(TitleBarType), typeof(TitleBarType), typeof(MicaWindow), new UIPropertyMetadata(TitleBarType.WinUI));
    ...
    public MicaWindow()
    {
        ...
        {
            Source = new Uri("/MicaWPF.Lite;component/Styles/Controls/MicaWindow.xaml", UriKind.RelativeOrAbsolute),
        };
        ...
        Style = OsHelper.IsWindows11_OrGreater
            ? myResourceDictionary["MicaWPF.Lite.Styles.Default.MicaWindow.Windows11"] as Style
            : myResourceDictionary["MicaWPF.Lite.Styles.Default.MicaWindow.Windows10"] as Style;
    }
